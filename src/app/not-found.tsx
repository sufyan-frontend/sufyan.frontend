...
export const metadata: Metadata = {
  title: "404 — Page Not Found | Muhammad Sufyan",
  description: "The page you are looking for does not exist. Visit the Muhammad Sufyan portfolio home page to explore projects, services, and the blog.",
