...
export const metadata: Metadata = {
  title: "Solitaire Royale Privacy Policy",
  description:
  ...
  alternates: { canonical: `${siteUrl}/privacy/solitaire-royale` },
};
...
export default function SolitaireRoyalePrivacyPage() {
  return (
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-12">
          ...
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              <h1 className="text-2xl sm:text-3xl font-bold text-surface">Solitaire Royale Privacy Policy</h1>
          ...
          <p className="text-surface/55 text-sm leading-relaxed">
            Solitaire Royale is a collection of five solitaire card games for Fire TV and Fire tablets.
            It asks for no permissions at all, has no internet access, and collects nothing. Your games
            and statistics stay on the device. This page sets out exactly what the app can and cannot do.
          </p>
        </div>
        ...
        <p className="mt-10 text-surface/30 text-xs text-center leading-relaxed">
          This policy covers the Solitaire Royale app only. The website itself is covered by the{" "}
