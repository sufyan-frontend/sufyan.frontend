...
export const metadata: Metadata = {
  title: "Nonogram Gallery Privacy Policy",
  description:
  ...
  alternates: { canonical: `${siteUrl}/privacy/nonogram-gallery` },
};
...
export default function NonogramGalleryPrivacyPage() {
  return (
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-12">
          ...
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              <h1 className="text-2xl sm:text-3xl font-bold text-surface">Nonogram Gallery Privacy Policy</h1>
          ...
          <p className="text-surface/55 text-sm leading-relaxed">
            Nonogram Gallery is a collection of picture logic puzzles for Fire TV and Fire tablets.
            It asks for no permissions at all, has no internet access, and collects nothing. Your solved
            pictures and saved grids stay on the device. This page sets out exactly what the app can and cannot do.
          </p>
        </div>
        ...
        <p className="mt-10 text-surface/30 text-xs text-center leading-relaxed">
          This policy covers the Nonogram Gallery app only. The website itself is covered by the{" "}
