    ...
    <>
      ...
      <header className="h-14 border-b border-white/5 bg-card/60 backdrop-blur-sm sticky top-0 z-20 flex items-center gap-3 px-4 sm:px-6 shrink-0">
        ...
        <div className="ml-auto flex items-center gap-2">
          <a
            href={`https://www.linkedin.com/sharing/share-offsite/?url=${encodeURIComponent(`https://sufyan-frontend.vercel.app/posts/${slug}`)}`}
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center gap-1.5 px-4 py-1.5 text-sm bg-[#0A66C2]/10 text-[#4D9FE8] font-medium rounded-xl hover:bg-[#0A66C2]/20 transition-colors"
          >
          ...
          <div className="mt-16 pt-8 border-t border-white/5 flex items-center justify-between flex-wrap gap-4">
            ...
            <div className="flex items-center gap-3">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 bg-[#0A66C2]/10 text-[#4D9FE8] px-4 py-2 rounded-xl text-sm font-medium hover:bg-[#0A66C2]/20 transition-colors"
              >
